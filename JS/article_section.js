  ...
  let post = [
    {
      ...
      nsfw_lbel: "NSFW_label",
      nsfw_filter: "filter_NSFW ",
      click: "2/356",
      time: "12分前",
    },
    {
              ...
              <a href="./post.html" class="article_title">
                  <div style="width: 200px; height: 100px;" class="article_title_img position-relative">
                      <span class="position-relative ">
                          <img class=" w-100 h-100 filter ${post[currentIndex].nsfw_filter} " href="./post.html" src="${post[currentIndex].img}">
                          <span class="${post[currentIndex].nsfw_lbel}"></sapn>
                      </span>
                  </div>
                  <div class="article_title_title">
